...
{
	HAL_I2C_Mem_Read(BU27006MUCZ_I2C,BU27006MUCZ_READ_ADDRESS,regAddr,1,data,1,200);
}
/*========================================================================================================================================= 
...
{
	HAL_I2C_Mem_Read(BU27006MUCZ_I2C,BU27006MUCZ_READ_ADDRESS,regAddr,1,data,byteQuantity,200);
}
/*========================================================================================================================================= 
...
void GB_BU27006MUCZ_Write_Command( uint8_t cmd)
{
	uint8_t TBuff[1];
	TBuff[0]=cmd;
	HAL_I2C_Master_Transmit(BU27006MUCZ_I2C,BU27006MUCZ_WRITE_ADDRESS,TBuff,1,100);
}
/*========================================================================================================================================= 
...
{
	HAL_I2C_Mem_Write(BU27006MUCZ_I2C,BU27006MUCZ_WRITE_ADDRESS,regAddr,1,&data,1,200);
}
/*========================================================================================================================================= 
...
{
	HAL_I2C_Mem_Write(BU27006MUCZ_I2C,BU27006MUCZ_WRITE_ADDRESS,regAddr,1,data,byteQuantity,200);
}
/*=========================================================================================================================================
